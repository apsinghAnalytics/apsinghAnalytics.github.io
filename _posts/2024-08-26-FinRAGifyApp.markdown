...
<p align="center"> <img width="300" src="https://raw.githubusercontent.com/apsinghAnalytics/FinRAGify_App/main/images/finragify.png"> </p>
...
1. **Information Retrieval**: When a user asks a question, FinRAGify retrieves the most relevant chunks of earnings call transcripts from the FAISS vector database based on the similarity to the query.

2. **Contextual Generation**: These retrieved chunks are provided as context to the language model (GPT-4 mini), which then generates a concise and accurate response.
...
### **How FinRAGify 'Answers': Retrieval, Reranking, and Generation**
